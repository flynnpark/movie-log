...
export interface Query {
  ...
  GetRatedMovies: GetRatedMoviesResponse;
...
export interface GetRatedMoviesQueryArgs {
  userId: number;
}
...
export interface GetRatedMoviesResponse {
  ok: boolean;
  error: string | null;
  ratedMovies: Array<RatedMovie> | null;
}
